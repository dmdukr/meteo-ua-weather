...
export interface WeatherForecastCardMonthlyGridConfig {
  show?: boolean;
  columns?: number;
  show_wind?: boolean;
  compact?: boolean;
...
export interface WeatherForecastCardConfig {
  type: "custom:weather-forecast-card" | "custom:meteo-ua-weather-forecast-card";
  entity: string;
  name?: string;
  ...
  monthly_grid?: WeatherForecastCardMonthlyGridConfig;
